	...
	return (
		...
		>
			...
			<div className="max-w-7xl mx-auto px-6 relative z-10">
				{/* About Me Section */}
				<div className="grid lg:grid-cols-[300px,1fr] gap-12 items-start mb-20">
					<div
					...
					>
						<ArrowRight className="w-12 h-12 text-white mb-8" />
							...
							{experiences.map((exp, index) => {
								return (
									...
									>
										...
										<div className="bg-[#1a1a1a] rounded-xl p-6 transition-all duration-300 h-[350px] flex flex-col ring-2 ring-[#8b5cf6]">
